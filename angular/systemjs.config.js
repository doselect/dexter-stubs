...
(function(global) {
  System.config({
    ...
    map: {
      ...
      // angular bundles
      '@angular/animations': 'npm:@angular/animations@5.0.1/bundles/animations.umd.js',
      '@angular/animations/browser': 'npm:@angular/animations@5.0.1/bundles/animations-browser.umd.js',
      ...
      '@angular/platform-browser/animations': 'npm:@angular/platform-browser@5.0.1/bundles/platform-browser-animations.umd.js',
      ...
      '@angular/router/upgrade': 'npm:@angular/router@5.0.1/bundles/router-upgrade.umd.js',
      '@angular/forms': 'npm:@angular/forms@5.0.1/bundles/forms.umd.js',
      '@angular/upgrade': 'npm:@angular/upgrade@5.0.1/bundles/upgrade.umd.js',
      '@angular/upgrade/static': 'npm:@angular/upgrade@5.0.1/bundles/upgrade-static.umd.js',
